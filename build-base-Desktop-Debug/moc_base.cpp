...
QT_MOC_LITERAL(1, 18, 13), // "imageReceived"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5), // "image"
QT_MOC_LITERAL(4, 39, 9), // "float64_t"
QT_MOC_LITERAL(5, 49, 3), // "lat"
QT_MOC_LITERAL(6, 53, 3) // "lon"

    },
    "MQTTImageReceiver\0imageReceived\0\0image\0"
    "float64_t\0lat\0lon"
};
...
static const uint qt_meta_data_MQTTImageReceiver[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QPixmap, 0x80000000 | 4, 0x80000000 | 4,    3,    5,    6,
...
void MQTTImageReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MQTTImageReceiver *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->imageReceived((*reinterpret_cast< const QPixmap(*)>(_a[1])),(*reinterpret_cast< float64_t(*)>(_a[2])),(*reinterpret_cast< float64_t(*)>(_a[3]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MQTTImageReceiver::*)(const QPixmap & , float64_t , float64_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MQTTImageReceiver::imageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MQTTImageReceiver::imageReceived(const QPixmap & _t1, float64_t _t2, float64_t _t3)
{
